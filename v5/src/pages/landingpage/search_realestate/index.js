/**
 * 落地页
 * https://m.liepin.com/landingpage/search_realestate.shtml
 */
            ...
            content: `
              <div class="info-mask">
                <div class="job-info clearfix">
                  ...
                  <span class="job">${data.data.ejob_title}</span><span class="salary">${data.data.ejob_salary}</span></a>
                ...
                <div class="company-info">
                  ...
                  <p class="boon-box">${boonHtml}</span></p>
                </div>
